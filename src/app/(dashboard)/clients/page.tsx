...
import { getIdentifierTypeDisplayName, getOrganizationTypeDisplayName } from "@/lib/converts";
...
export default function ClientAccountPage() {
  const { data: account = defaultAccount, isLoading } = useQuery({
    ...
    queryFn: () => clientService.getDetails(),
    initialData: defaultAccount,
  });

  const breadcrumbItems = [
    { label: "Configuracion", href: "/settings" },
    { label: account.businessName || "Empresa", href: `/clients` }
  ];
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <span className="text-sm text-gray-900">
                  {getOrganizationTypeDisplayName(account.organizationType) || <span className="text-gray-400">No definido</span>}
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <span className="text-sm text-gray-900">
                  {getIdentifierTypeDisplayName(account.identifierType) || <span className="text-gray-400">No definido</span>}
                </span>
              </div>
            </div>
